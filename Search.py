...
class Search(Frame):
    ...
    def createGUI(self):
        self.frame = Frame(master=window, width=330, height=330)
        self.frame.pack()

        self.title = Label(master=self.frame, text="SEARCH EMPLOYEE")
